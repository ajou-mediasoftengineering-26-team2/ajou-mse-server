...
import team2.mse.ajou.server.domain.auth.service.IAuthService;
...
public class AuthController {
    ...
    public AuthController(IAuthService authService, PlayerDataJpaRepository playerDataJpaRepository) {
